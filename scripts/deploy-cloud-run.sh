...
LOCAL_FRONTEND_ORIGINS="${LOCAL_FRONTEND_ORIGINS:-http://localhost:5173,http://127.0.0.1:5173}"
CORS_ALLOWED_ORIGINS="${CORS_ALLOWED_ORIGINS:-${FRONTEND_ORIGIN},${LOCAL_FRONTEND_ORIGINS}}"
