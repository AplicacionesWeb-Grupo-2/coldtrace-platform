...
namespace ColdTrace.Platform.Migrations
{
    ...
    [Migration("20260710224719_NormalizeAlertLifecycleValues")]
    partial class NormalizeAlertLifecycleValues
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ColdTrace.Platform.Iam.Domain.Model.Aggregates.ExternalIdentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ColdTrace.Platform.Iam.Domain.Model.Aggregates.PasswordResetRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ColdTrace.Platform.Alerts.Domain.Model.Aggregates.AiResolutionPlan", b =>
                {
                    ...
                    b.HasOne("ColdTrace.Platform.Iam.Domain.Model.Aggregates.Organization", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ColdTrace.Platform.Iam.Domain.Model.Aggregates.ExternalIdentity", b =>
                {
                    b.HasOne("ColdTrace.Platform.Iam.Domain.Model.Aggregates.User", null)
                        .WithMany()
